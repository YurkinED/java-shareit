...
class UserServiceTests {
    ...
    void setUp() {
        ...
        inputUserDto = new UserDto(1L, "testUserName", "testUser@email.com");
        expectedUser = new User(1L, inputUserDto.getName(), inputUserDto.getEmail());
        expectedUsersList = List.of(new User(1L, "userName", "userEmail@mail.com"));
    }
